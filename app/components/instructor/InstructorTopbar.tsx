...
export default function InstructorTopbar({ onCreateCourse }: Props) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-surface/80 backdrop-blur-xl">
      <div className="flex h-16 items-center gap-2 px-3 sm:px-4 lg:gap-4 lg:px-6">
        {/* Logo */}
        ...
        <div className="ml-auto flex items-center gap-1">
          ...
          <NotificationBell />
          <button className="hidden w-9 h-9 items-center justify-center text-on-surface-variant hover:text-primary rounded-lg hover:bg-white/5 transition-colors sm:flex">
      ...
      {mobileMenuOpen && (
        <div className="border-t border-white/10 bg-surface/95 px-3 py-3 shadow-xl md:hidden">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 border-t border-white/10 pt-3">
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-lg bg-primary px-3 py-2.5 text-sm font-semibold text-on-primary transition-all hover:brightness-110 active:scale-95"
            >
              <span className="material-symbols-outlined" style={{ fontSize: 16 }}>
                add
              </span>
            ...
            <button className="flex items-center justify-center gap-1.5 rounded-lg border border-white/10 px-3 py-2.5 text-sm font-semibold text-on-surface-variant transition-colors hover:bg-white/5 hover:text-on-surface">
              <span className="material-symbols-outlined" style={{ fontSize: 16 }}>
                settings
              </span>
              Settings
