...
export default function PublicCoursesPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-on-surface px-4 py-10">
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-on-surface-variant">
              Browse published courses and find the next lesson path.
            </p>
          </div>

          <form
            onSubmit={handleSearch}
            className="grid gap-2 sm:grid-cols-[240px_150px_92px]"
          >
        ...
        {loading ? (
          <div className="glass-card rounded-xl py-16 text-center text-on-surface-variant">
            <span
          ...
          <div className="glass-card rounded-xl py-16 text-center text-error">
          ...
          <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((course) => (
              <article
                ...
                className="glass-card cursor-pointer overflow-hidden rounded-xl border border-white/10 focus:outline-none focus:ring-1 focus:ring-primary/50"
              >
